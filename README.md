...
The one link to send friends before game night. A small menu page that links out to three browser party games — pick one, tap it, everyone's in.
...
```
index.html    three linked cards, one per game
